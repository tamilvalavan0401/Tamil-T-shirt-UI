...
export default function LoginMobile() {
  ...
  const handleResendOtpMobile = () => {
    startCountdown()
    // Here you would typically trigger a new OTP send API call for mobile
    console.log("Resending OTP to mobile...")
  }

  const handleGenerateOtpEmail = () => {
  ...
  const handleResendOtpEmail = () => {
    startCountdown()
    // Here you would typically trigger a new OTP send API call for email
  ...
  useEffect(() => {
    ...
    setIsLoadingMobile(false)
    setMobileNumberError("")
    setMobileNumber("") // Clear mobile number on tab switch

    setOtpSentEmail(false)
    setOtpEmail(["", "", "", ""])
    setIsLoadingEmail(false)
    setEmailAddressError("")
    setEmailAddress("") // Clear email address on tab switch
  ...
  return (
    <div className="flex max-h-full md:h-screen md:items-center items-stretch md:justify-center justify-end bg-gray-100 md:p-8">
      <div className="w-full max-w-5xl overflow-hidden md:rounded-[6px] md:shadow-lg md:grid md:grid-cols-2  ">
        {/* Left Section - Media Carousel (Desktop) / Top Background (Mobile) */}
              ...
              <div className="space-y-2">
                ...
                <div
                  className={`flex items-center h-[52px] rounded-[6px]  border-2 ${
                    mobileNumberError ? "border-red-500" : "border-[#CECECE]"
                ...
                {mobileNumberError && <p className="text-sm text-red-500">{mobileNumberError}</p>}
              </div>

              {!otpSentMobile ? (
                <Button
                  className="w-full bg-button-green py-2 text-white bg-[#457dff] h-[52px] rounded-[6px] hover:bg-button-green/90"
                ...
                <>
                  ...
                  <Button className="w-full bg-button-green py-2 text-white bg-[#457dff] !rounded-[6px] !h-[52px] hover:bg-button-green/90">
                    verify account
                  </Button>
                </>
              )}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setEmailAddressError("") // Clear error on change
                  }}
                  onKeyDown={(e) => {
                  ...
                  className={`w-full rounded-md border-2 ${
                    emailAddressError ? "border-red-500" : "border-[#CECECE]"
                ...
                />
                {emailAddressError && <p className="text-sm text-red-500">{emailAddressError}</p>}
              </div>
              {!otpSentEmail ? (
                <Button
                  className="w-full bg-button-green py-2 text-white bg-[#457dff] h-[52px] rounded-[6px] hover:bg-button-green/90"
