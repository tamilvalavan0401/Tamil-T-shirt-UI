    ...
    <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="!max-w-[90rem] mx-auto ">
          ...
          <div className="flex md:p-[0px] p-[16px]">
            ...
            <main className="md:!w-10/12 !w-12/12 ">
              ...
              {productsToShow.length > 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 gap-4">
                  <div className="flex flex-col items-center justify-center h-[50vh] text-center invisible hidden md:block">
                  ...
                  <div className="flex flex-col items-center justify-center h-[50vh] text-center ">
                      ...
                      <Image src={bag} alt="Bag" className="w-[300px] pb-[30px] opacity-70" />
                    <p className="text-lg text-[#363735] font-medium mb-4">No products found. View more products!</p>
                    <Button asChild className="bg-yellow-500 hover:bg-yellow-600 text-white">
                      <Link href="/cart">View More Products</Link>
                    </Button>
